...
class Juego:
    ...
    def obtener_estados_posibles(self, estado):
        nodo_actual = self.buscar_coordenada_n(estado.matriz, 0)
        #print(nodo_actual.x)
        #-----
    ...
    def distancia_manhattan(self, matriz, matriz_final):
        distancia = 0
        for i in range(9):
            coordenada_inicial = self.buscar_coordenada_n(matriz, i)
            coordenada_final =   self.buscar_coordenada_n(matriz_final, i)
            distancia += abs( coordenada_inicial.x - coordenada_final.x   ) + abs(  coordenada_inicial.y - coordenada_final.y  )  
        return distancia            
    ...
    def buscar_ruta(self):
        ...
        if self.estado_inicial != self.estado_final:
            ...
            self.estado_actual.h = self.distancia_manhattan(self.estado_actual.matriz, self.estado_final.matriz)
            ...
            while not self.comparar_matrices( self.estado_actual.matriz , self.estado_final.matriz):
                ...
                for e in self.lista_jugadas:
                    ...
                    e.h = self.distancia_manhattan(e.matriz, self.estado_final.matriz)
                    e.f = e.g + e.h
